...
relevance_criteria = st.sidebar.text_area("Relevance Criteria", height=200, value="""Classify responses as 'Relevant' unless they add no value or are unrelated to the question. Assess with an inclination towards finding relevance:
...
""")
ai_criteria = st.sidebar.text_area("AI Generation Criteria", height=200, value="""Evaluate the probability that the response was generated by an AI. Look for indicators like:
